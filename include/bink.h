...
int bink_var_get_int(BINK_Story *story, char *name, int *value, char **err_msg);
int bink_var_set_int(BINK_Story *story, char *name, int value, char **err_msg);
int bink_var_get_float(BINK_Story *story, char *name, float *value, char **err_msg);
int bink_var_set_float(BINK_Story *story, char *name, float value, char **err_msg);
int bink_var_get_bool(BINK_Story *story, char *name, bool *value, char **err_msg);
int bink_var_set_bool(BINK_Story *story, char *name, bool value, char **err_msg);
int bink_var_get_string(BINK_Story *story, char *name, char **value, char **err_msg);
int bink_var_set_string(BINK_Story *story, char *name, char *value, char **err_msg);
